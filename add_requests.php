			   ...
			   <div class="form-group">
				...
				<div class="form-group">
                  <label> Mobile Number </label>
                    <input class="form-control" name="txtMobile"  value="<?php echo $row['txtMobile']?>" required="" />
                ...
                <div class="form-group">
                  <label>Ad Category</label>
                    <select class="form-control" name="txtC_Category" id="txtC_Category" required="">
                        <option value="">Select Category</option>
                        <!--<?php $cath = $db->query ("SELECT `name` FROM `cat` ORDER BY `name` ASC");
                              while($carow = $cath->fetch()) {
                              echo "<option value='".$carow[0]."'"; if($row['txtC_Category']==$carow[0]){ echo " selected "; } echo ">".$carow[0]."</option>";
                        } ?>-->
						  <?php $citt = $db->query("SELECT * FROM `cat` ORDER BY `name` ASC");
                ...
                <!--<div class="form-group">
				 ...
				 <div class="form-group">
                  <label>Advertiser/Title</label>
                    <select class="form-control" name="txtAdTitle" id="txtAdTitle" required="">
                        <option value="">Select Title</option>
                        <?php $cath = $db->query ("SELECT `name` FROM `subv`");
                              while($carow = $cath->fetch()) {
                              echo "<option value='".$carow[0]."'"; if($row['txtAdTitle']==$carow[0]){ echo " selected "; } echo ">".$carow[0]."</option>";
                        } ?>
                   </select>
                </div>
                <div class="form-group">
                ...
                <table id="SampleDT" class="datatable table table-hover table-striped table-bordered tc-table ">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <b>Ad Category:</b> <?php echo $row['txtC_Category']; ?><br /><b>Ad Title:</b> <?php echo $row['txtAdTitle']; ?><br /><b>Ad Membership no:</b> <?php echo $row['txtMembership_no']; ?></small></td>
                      <td class="center" width="30%"><div class="panel panel-body"><?php $des = str_replace("^^","'",$row['txtContent']); echo $des = str_replace('~~','"',$des); ?></div></td>
