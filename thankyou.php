...
$date = date('Y-m-d');
	...
	$workingKey='23F946CB1519851AD415BD82B7DB36E0';		//Working Key should be provided here.
   ...
   //  print_r($rcvdString);exit;
...
else if($_GET['addtype']=='CATEGORY AD'){ 
...
else if($_GET['addtype']=='MATRIMONIAL AD'){ 
...
else if($_GET['addtype']=='JOB SEEKER AD'){ 
...

	{
		...
		$message =	"Your Transaction has been Aborted";
...

	{
			...
			$message =	"Your Transaction has been Declined, Failed";
        ...
        <div class="col-md-12">
          ...
          <div class="row" style="padding-top:20px">
            ...
            <div class="col-md-12 col-sm-12 text-center">
               ...
               <h2 style="color:#37b649;">  <?php echo $message;?>.</h2>
