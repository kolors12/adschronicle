...
$to = $qs;
    ...
    // $amessage = $code." is your OTP for Franchise Application submission - AdsChronicle.com";
    // $amessage = "Dear User, OTP to verify your mobile number is $code. Thank you, AdsChronicle.com";
