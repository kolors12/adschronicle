...
<a href="job_seeker_ad.php"  class="col-xs-12" style="background-color:#0AD397; text-transform:uppercase; text-decoration:none; color:#fff;"><small>Job Seeker Ad</small></a>
<div class="clearfix"></div>
              </div>
            </div>
          </div>
                ...
                <div class="col-md-8 col-md-offset-2 im">
                  ...
                  <div class="input-group">
                   ...
                   <option value="">Select Classified Category</option>
                    <?php $clth = $db->query("SELECT * FROM `cat`");
                        while($clt = $clth->fetch()){
                          echo '<option value="'.$clt[0].'">'.$clt[1].'</option>';
                        }?>
                   </select>
                  </div>
                  
                  <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                   <select name="txt_sub" id="state" class="form-control required">
