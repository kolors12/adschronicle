<?php ob_start(); error_reporting(0);
  ...
  if(isset($_POST) && $_POST['submit'] == 'Submit'){
      ...
      if(!empty($_POST['txtName']) && !empty($_POST['txtMobile']) && !empty($_POST['txtEmail'])){
		 ...
		 //echo "INSERT INTO `adds_requests`(`txtName`, `txtMobile`, `txtEmail`, `txtAdTitle`, `txtContent`,`txtC_Category`, `txtC_City`,  `txtMembership_no`, `date`) VALUES ('$txtName', '$txtMobile', '$txtEmail', '$txtAdTitle', '$txtContent', '$txtC_Category', '$txtC_City', '$txtMembership_no', '$date')"; exit;
...
<div class="clearfix"></div>
        ...
        <div class="col-md-6" >
          ...
          <div style="padding-top:20px" align="center">
           <h5><strong style="color:#F37F03">SPECIAL CATEGORIES</strong></h5>
...
<img src="adminupload/<?php echo $baarow['image']?>"  style="width:200px;height:200px; border:1px #5bc0de solid" alt=""/>
