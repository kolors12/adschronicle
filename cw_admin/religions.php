  ...
  <div id="page-wrapper"> 
    ...
    <div class="row">
      <div class="col-lg-12"> 
            ...
            <ul>
              <li class="dropdown"><a href="#" title="" data-toggle="dropdown"><i class="fa fa-plus"></i><span> Tasks</span></a>
                <ul class="dropdown-menu dropdown-primary dropdown-menu-right">
                  ...
                  <li><a href="<?php echo URL; ?>religions.php">View Religions</a></li>
                </ul>
              </li>
            </ul>
          </div>
        ...
        <div class="page-header title"> 
          <!-- PAGE TITLE ROW -->
          <h1>Admin <span class="sub-title"><a href="religions.php">Religions</a></span></h1>
        </div>
    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <?php  }
								$sth = $db->query ("SELECT * FROM `religions`");
								$count = $sth->rowCount();
								// $count;
								 ?>
                ...
                <table id="SampleDT" class="datatable table table-hover table-striped table-bordered tc-table ">
                  <thead>
                    <tr>
                      ...
                      <th data-class="expand" class="col-medium center">Religion Name</th>
                      <th data-class="expand" class="col-medium center">Sects</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="col-medium center"><div class="btn-group btn-group-sm"><a href="<?php echo URL; ?>sects.php?sid=<?php echo $row[0]; ?>" class="btn btn-inverse"><i class="fa fa-link icon-only"></i></a></div></td>
