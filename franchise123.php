            ...
            <div class="panel-body" style="font-size:12px">
              ...
              <div class="clearfix"></div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control required" name="txtQualification" placeholder="Highest Qualification"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-6 control-label">Year of passing :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control number required" maxlength="4" name="txtPassingYear" placeholder="Year of passing">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-6 control-label">Business experience (yr):</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control number required" name="txtBusinesExp" placeholder="Business experience (yr)">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-6 control-label">Nature of Business :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control required" name="txtBusinessNature" placeholder="Nature of Business">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control required" name="txtExpectMonthly" placeholder="Rs.">
                  </div>
                </div>
                <div class="form-group">
