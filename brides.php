              ...
              <div class="row" style="border:1px #eee solid; margin:5px">
                ...
                <div class="col-md-9">
                  <div style="padding-top:30px">
                    <p class="pull-left" maxlength="20"><?php echo $row['txtName'] ?> | Age: <?php echo $row['txtAge'] ?> yrs | Height: <?php echo $row['txtHeight']?> Cms | <?php echo $row['txtComplexion']?> | <?php echo $row['txtQualification']?>  | <?php echo $row['txtOccupation'] ?></p>
                    <p class="pull-right"><strong><a href="biodata.php?profile=<?php echo $row['pid']?>&txtReligion=<?php echo $_GET[txtReligion]; ?>&txtSect=<?php echo $_GET[txtSect]; ?>&txtMstatus=<?php echo $_GET[txtMstatus]; ?>&searchby=<?php echo $_GET[searchby]; ?>&search=<?php echo $_GET[search]; ?>">Biodata / More Details</a></strong></p>
                    <div class="clearfix"></div>
