...
$pid=$_GET['profile'];
   	    $row = $db->query("SELECT * FROM  `jobseeker_ads` WHERE  pid='$pid' ORDER BY `guid` DESC")->fetch();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tbody>
    <tr>
      <td width="25%" align="center"><strong><button onclick="window.history.back()">Back</button></strong></td>
