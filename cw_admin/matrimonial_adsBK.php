              ...
              <div class="portlet-body col-sm-12">
                ...
                <form role="form" class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <div class="col-sm-12">
                        <select class="form-control required" id="mstatus" name="txtMstatus" aria-required="true">
                          ...
                          <option <?php if($row['txtMstatus']=='Divorced'){ echo 'selected=""'; }?>>Divorced</option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="col-sm-12">
                        <select class="form-control required" name="txtChildren">
                  ...
                  <table id="SampleDT" class="datatable table table-hover table-striped table-bordered tc-table ">
                    <thead>
                      <tr>
                        ...
                        <th data-class="expand" class="center">Bride/BrideGroom</th>
