          ...
          <div style="padding:3px; border-radius:4px">
            <div align="center">
              <div data-toggle="tooltip" data-placement="right" title="These Ads are displayed under Classified advertisements" style="line-height:2.3">
                ...
                <a href="catagory_ads_form.php"  class="col-xs-12" style="background-color:#DB0483;text-transform:uppercase; text-decoration:none; color:#fff;"><small> Publish BUSINESS  Ad</small></a>
                <div class="clearfix"></div>
                </div>
...
<strong>Job Seekers can upload their video Resumes</strong></p>
        ...
        <div class="col-md-12" style="padding-top:5px">
          <div class="col-md-12">
            <h5><strong style="color:#F37F03">HOT BUSINESSES</strong></h5>
          </div>
          <div class="col-md-12">
            <div class="row">
        ...
        <div class="col-md-12">
          <div class="col-md-12">
            <h5><strong style="color:#F37F03">FEATURED BUSINESSES</strong></h5>
          </div>
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 im">
                  <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" placeholder="Full Name" class="form-control required" name="txtName" autocomplete="off" />
                  </div>
                  <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                    <input type="text" placeholder="Mobile No" class="form-control number required" name="txtMobile" id="txtMobile" minlength="10" maxlength="10" autocomplete="off" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"/>
                     <span id="span4"></span>
                  </div>
                  <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                    <input type="email" placeholder="EMail-id" class="form-control email required" name="txtEmail" autocomplete="off" />
                  </div>
                  ...
                  <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                    <input type="text" placeholder="Enter Ad Agency's membership no" class="form-control required" name="txtMembership_no" autocomplete="off" />
                  </div>
                  
                  <div class="input-group otp-block" style="display: none;">
...
$("#txtMobile").keyup(function(){
       ...
       if($.isNumeric(userphone) && userphone.length==10){
    	  $.ajax({
    			type:"post",
    			url:"cw_admin/ajaxScripts/adsverification.php",
    			data:"qs="+userphone,
                beforeSend: function(){
