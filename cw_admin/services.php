                  ...
                  <form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="phone_no2" placeholder="Enter Phone/Mobile Number 2" />
                    </div>
                     <div class="form-group">
              ...
              <div class="portlet-body col-sm-12">
                ...
                <form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label>Phone/Mobile 2</label>
                      <input type="text" class="form-control" name="phone_no2" value="<?php echo $row['phone_no2']?>" placeholder="Enter Phone/Mobile Number 2" />
                    </div>
                     <div class="form-group">
                      <label>Web Site</label>
                      <input type="text" class="form-control" name="website" value="<?php echo $row['website']?>" placeholder="Enter Website Name" />
                    </div>
                     <div class="form-group">
                      <label>Contact Person</label>
...
$.ajax({
		  ...
		  data:"guid="+id+"&action=categoryad",
			  success:function(response){
