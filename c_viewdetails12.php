...
if(isset($_POST) && $_POST['submit']=='Save Details'){
    ...
    $to1 = $txtEmail;
    $subject1 = "You have recived an enquery through AdsChronicle.com";
    $message1 = "
    Hi, $txtName\n
    Your Enquiry PostAdd Details\n
    Name: ".$srow['add_title']."\n
    ...
    $to = $srow['email_id'];
    $subject = "You have recived an enquery through AdsChronicle.com";
    $message = "
    Name: $txtName\n
    Email: $txtEmail\n
    Mobile: $txtMobile\n
    ...
    if($count > 4){
        ...
        if($sth >0){
            ...
            $message = "
            Hi,
            You have received Discount voucher in AdsChronicle.com.\n
...
<?php echo $srow['offered_services']?>
              ...
              <div class="row">
               <div class="col-md-12"> <a class="read-more btn" style="background-color:#b9a7fa; width:100%; color:#fff" role="button" data-toggle="collapse" href="#collapseExample1" aria-expanded="false" aria-controls="collapseExample">Save this Advertiser's details in your Mobile/Email</a> </div>
               </div>
            </div>
            <div class="col-md-6" >
              <div style="background-color:#f5f5f5; padding:10px">
                ...
                <div class="row" style="padding:5px 5px 5px 5px">
                 ...
                 <div class="col-md-8"  style="padding-left:5px">
                    <div class="panel panel-default" style="margin-bottom:0px">
                      <div class="panel-heading " align="center"><strong style="<?php  if($srow['images4']==''){ echo ''; } else { echo 'color:#F30'; }  ?>"><?php  if($srow['images4']==''){ echo ''; } else { echo 'DEAL OF THE DAY OFFER'; }  ?></strong></div>
                      <div class="panel-body">
                        <div class="row">
                          <div class="col-md-6">
						  <!--p><strong>Discount tile</strong></p-->
                            ...
                            <a class="btn btn-primary" href="javascript:;" data-backdrop="static" data-toggle="modal" data-target="#<?php  if($srow['images4']==''){ echo 'disabled'; } else { echo 'myModalcoupon'; }  ?>" <?php  if($srow['images4']==''){ echo 'disabled'; } else { echo 'color:#F30'; }  ?> role="button"  style="margin-top:80px"><i class="glyphicon glyphicon-thumbs-up"></i> Get Coupon Code</a>
