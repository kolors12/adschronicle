    ...
    <div class="container shadow"  style="background-color:#fff">
      ...
      <div class="row" style="padding:10px 0px 30px 0px;">
        <div class="col-md-12" style="background-image:url(images/bg-b.jpg); margin-bottom:30px">
          <div style="font-size:16px; color:#fff; font-weight:bold; padding:10px" align="center"><?php echo ucfirst($_GET['searchby']) ?></div>
        </div>
        <form method="get" action="brides.php">
          ...
          <div class="col-md-3">
            ...
            <button type="button" class="btn btn-info col-xs-12" data-toggle="modal" data-target="#verify">Search</button>
