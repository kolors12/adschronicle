...
if(isset($_POST) && $_POST['submit']=='Submit'){
    unset($_POST['submit']);
		 ...
		 $txtFullname           =$_POST['txtFullname'];
                 $txtOfficeAddress      =$_POST['txtOfficeAddress'];
		 $txtPhoneno            =$_POST['txtPhoneno'];
                 $txtMobile             =$_POST['txtMobile'];
                 $txtEmail              =$_POST['txtEmail'];
		 $txtQualification      =$_POST['txtQualification'];
		 $txtPassingYear        =$_POST['txtPassingYear'];
		 $txtBusinesExp         =$_POST['txtBusinesExp'];
		 $txtBusinessNature     =$_POST['txtBusinessNature'];
		 $txtBusinessActivity   =$_POST['txtBusinessActivity'];
		 $txtPremiseshave       =$_POST['txtPremiseshave'];
		 $txtPremisesNature     =$_POST['txtPremisesNature'];
		 $txtPremisesArea       =$_POST['txtPremisesArea'];
		 $txtNeedTime           =$_POST['txtNeedTime'];
		 $txtExecutivesNumber   =$_POST['txtExecutivesNumber'];
		 $txtExpectMonthly      =$_POST['txtExpectMonthly'];
		 $txtInvestMonthly      =$_POST['txtInvestMonthly'];
		 $date                  =$date;
         ...
         $to ="admin@adschronicle.com,elitefocus@gmail.com";
         $subject = " Resellers/Franchisees Invited form from adschronicle.com";
...
$message = "
    Hi,\n
    You have receive Resellers/Franchisees Invited form from  adschronicle.com\n
    Request Details\n
    
    
        Full Name                                                                          : $txtFullname\n
	Office Address                                                                     : $txtOfficeAddress\n
	Phone Number                                                                       : $txtPhoneno\n
	Mobile Number                                                                      : $txtMobile\n
	Email                                                                              : $txtEmail\n
	Highest Qualification                                                              : $txtQualification\n
	Year of Passing                                                                    : $txtPassingYear\n
	Business Experience(yr)                                                            : $txtBusinesExp\n
	Nature of Business                                                                 : $txtBusinessNature\n
	Present Business/Activities                                                        : $txtBusinessActivity\n
	Whether having any premises ready to use?                                          : $txtPremiseshave\n
	If yes, nature of premises                                                         : $txtPremisesNature\n
	Premises Area (in sq.ft.)                                                          : $txtPremisesArea\n
	If premises is not ready how much time it needs?                                   : $txtNeedTime\n
	Number of Executives you intend to appoint or delegate for this Reseller Business  : $txtExecutivesNumber\n
	How much monthly income you are expecting from the proposed Reseller business?     : $txtExpectMonthly\n
	How much you can invest to achieve the above income                                : $txtInvestMonthly\n
	Clck here to view the photo    : https://adschronicle.com/adminupload/$image\n
            ...
            <div class="panel-body" style="font-size:12px">
              ...
              <div class="clearfix"></div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control required number " name="txtExpectMonthly" placeholder="Rs.">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-6 control-label">How much you can invest to achieve the above income : </label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control required number" name="txtInvestMonthly" placeholder="Rs.">
                  </div>
                </div>
